    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <form action="<?php echo base_url('/service/submit_register')?>" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="Your Role" name="role" value="<?php echo $role; ?>">
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="checkbox icheck">
                                <a href="<?php echo base_url('/apps'); ?>" class="text-center">I already have a membership</a>
<!--                                <label>
