        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">             
                    <!-- Main row -->
                    <div class="row">
                        <!-- up column chart addons -->
                        <?php // $this->load->view('content/dashboard/default/area_chart'); ?>

                        <!-- this all section -->
                        <section class="col-lg-12 connectedSortable">
                            <?php $this->load->view('content/dashboard/cloud/cloud_chart'); ?>
                        </section>

                        <!-- get all data by number of records -->
                        <!-- Left col -->
                        <section class="col-lg-7 connectedSortable">
                            <!-- TAB CHART -->
                            <?php $this->load->view('content/dashboard/sales/sales_chart'); ?>
                            <!-- DONUT CHART -->
                            <?php $this->load->view('content/dashboard/referral/referral_chart'); ?>
                        </section>
                        <!-- /.Left col -->
                        ...
                        <section class="col-lg-5 connectedSortable">
                            <!-- FUNNEL CHART -->
                            <?php $this->load->view('content/dashboard/transaction/transaction_chart'); ?>
                            <!-- BAR CHART -->
                            <?php $this->load->view('content/dashboard/paid/paid_chart'); ?>
