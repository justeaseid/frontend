        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('layout/title/title_monitor'); ?>
                </section>
                ...
                <section class="content">
                    <!-- Main row -->
                    <div class="row">
                        <?php $this->load->view('content/monitor/da1'); ?>
                        <?php $this->load->view('content/monitor/da2'); ?>
                        <?php $this->load->view('content/monitor/da3'); ?>
                        <?php $this->load->view('content/monitor/da4'); ?>
                    </div>
